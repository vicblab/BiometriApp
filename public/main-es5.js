...
/***/ "./src/app/ReceptorBLE.ts":
/*!********************************!*\
  !*** ./src/app/ReceptorBLE.ts ***!
  \********************************/
/*! exports provided: ServicioFirebaseService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ServicioFirebaseService", function() { return ServicioFirebaseService; });
...
var ServicioFirebaseService = /** @class */ (function () {
    function ServicioFirebaseService(fireStore, ble, btle, geolocation) {
        this.fireStore = fireStore;
        this.ble = ble;
        this.btle = btle;
        this.geolocation = geolocation;
        this.Collection = fireStore.collection('data');
    ...
    ServicioFirebaseService.prototype.suscribirse = function () {
        var _this = this;
        this.btle.subscribe('\n').subscribe(function (res) {
            _this.add(JSON.stringify(res));
        }, function (err) { throw (err); });
    };
    //funci�n comprobante que se llama a s� misma cada medio segundo y se suscribe si el bt es� activo y el dispositivo est� conectado
    ServicioFirebaseService.prototype.conectarse = function (id) {
        var _this = this;
        this.ble.autoConnect(id, function () { _this.suscribirse(); }, function () { });
    };
    //scan devices comprueba si el bt est� activado, si lo est� comprueba si est� conectado, si lo est� se suscribe, si no lo est� muestra
    //las opciones de bt y llama a la funci�n comprobante conectarse
    ServicioFirebaseService.prototype.encenderBT = function () {
        var _this = this;
        this.ble.isEnabled().then(function () {
            ...
            _this.ble.enable().then(function () {
            });
        });
    };
    ServicioFirebaseService.prototype.add = function (data) {
        var now = new Date().getTime().toString();
        var lat = "";
        var long = "";
        var alt = "";
        this.geolocation.watchPosition().subscribe(function (posi) {
    ...
    ServicioFirebaseService.ctorParameters = function () { return [
    ...
    ServicioFirebaseService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [angularfire2_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"], _ionic_native_ble_ngx__WEBPACK_IMPORTED_MODULE_3__["BLE"], _ionic_native_bluetooth_serial_ngx__WEBPACK_IMPORTED_MODULE_4__["BluetoothSerial"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_5__["Geolocation"]])
    ], ServicioFirebaseService);
    return ServicioFirebaseService;
}());
...
/* harmony import */ var _ReceptorBLE__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ReceptorBLE */ "./src/app/ReceptorBLE.ts");
...
/* harmony import */ var _ionic_native_bluetooth_serial_ngx__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ionic-native/bluetooth-serial/ngx */ "./node_modules/@ionic-native/bluetooth-serial/ngx/index.js");
/* harmony import */ var _ionic_native_ble_ngx__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @ionic-native/ble/ngx */ "./node_modules/@ionic-native/ble/ngx/index.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _ionic_native_bluetooth_serial_ngx__WEBPACK_IMPORTED_MODULE_13__["BluetoothSerial"],
                _ReceptorBLE__WEBPACK_IMPORTED_MODULE_9__["ServicioFirebaseService"],
                _ionic_native_ble_ngx__WEBPACK_IMPORTED_MODULE_14__["BLE"],
